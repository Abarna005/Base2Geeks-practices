  ...
  return (
    <div>
        ...
        <Box mt={-3.5} ml={6} sx={{width:'max-content',
          ...
          zIndex:'modal'}}>
            <Stack pt={2}>
                <Typography className='typography' variant='h5'>6 Months plan for</Typography>
                <Typography className='typography' variant='h5'>Two course</Typography>
                <Typography className='typography' variant='h6'>$800/<Typography className='typography' variant='caption'>member</Typography></Typography>
                ...
                <Stack direction="row" spacing={2} sx={{marginTop:'1rem'}}>
                  <Typography className='typography' variant='subtitle1' component='span' sx={bold}>No of Account</Typography>
